                    ...
                    if state.TeamPlayers.IsEmpty then
                      Html.div [
                        ...
                        prop.children [
                          ...
                          Html.button [
                            prop.className "inline-flex items-center justify-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700 transition-colors"
                            prop.onClick (fun _ -> dispatch (NavigateToPage ManageTeamPage))
                            prop.children [
                              Html.span "Go to team management"
                              Html.span [
